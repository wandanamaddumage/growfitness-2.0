import { api } from './api';
import type { Testimonial, PaginatedResponse } from '@grow-fitness/shared-types';
import type { CreateTestimonialDto, UpdateTestimonialDto } from '@grow-fitness/shared-schemas';
